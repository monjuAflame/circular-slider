(function () {
  ...
  function Slider(
    ...
    (this.startSetup = new startSetup(
      ...
      (this.afterSliderContent = newSlider.parentElement.nextElementSibling);
  ...
  Slider.prototype.onResize = function () {
    ...
    this.slidesHolder.style.background =
      this.slides[this.currentSlide].getAttribute("color");
  };
  ...
  Slider.prototype.slidesRepositioning = function (r) {
    for (let i = 0; i < this.slides.length; i++) {
      ...
      this.slides[i].style.transform =
        ...
        "deg )";
      this.slides[i].style.borderColor = this.slides[i].getAttribute("color");
    }
  };
  ...
  Slider.prototype.addStyle = function () {
    ...
    this.afterSliderContent.style.background =
      this.slides[x].getAttribute("color");
  };
